  ...
  const templateMenü = menü?.map((item) => (
    <li className="menü-list" key={item.id}>
      ...
      >
        <span>{item.name}</span>
        <span>
          <span className="me-5">{item.price} CHF</span>
            ...
            <div className="row d-flex justify-content-center">
              ...
              <div className="col-8 mb-3 mt-5 scrollspy d-flex justify-content-between">
                <ul className="list-unstyled " style={{ width: "500px" }}>
                  <p className="bestellungen-product">
                    Sie können erneut bestellen
                  </p>
                  {menü.length === 0 ? (
                    <img
                      src="images/logo.png"
                ...
                <div className="col-4">
                  <Link to="/onlineBestellung">
                    <button className="reservation-btn mt-2 px-4 pb-2 col rounded-2 position-relative">
                      Meinen Bestellungen{" "}
            ...
            <div>
              ...
              <div className="col-8 mb-5 container">
                ...
                >
                  <div className="my-3 mt-4 col-5">
                    <div className="input-group">
                      <input
                        ...
                        name="mittagsmenu"
                        onChange={(e) =>
                          setMittagsmenu(e.currentTarget.files[0])
                        }
                        required
                      />
                    </div>
                  ...
                  <button
                    type="submit"
                    className="reservation-btn my-3 px-5 rounded-4"
